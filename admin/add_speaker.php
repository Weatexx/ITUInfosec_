...
if (empty($errors)) {
    ...
    if ($dataManager->addSpeaker($data)) {
        echo "<h4 class='text-center text-success'><i class='bi bi-check-circle me-2'></i>Konuşmacı başarıyla eklendi.</h4>";
        include 'speakers.php';
    } else {
        echo "<h4 class='text-center text-danger'><i class='bi bi-exclamation-circle me-2'></i>Konuşmacı ekleme işlemi başarısız.</h4>";
    }
} else {
