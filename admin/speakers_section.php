...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dataManager->saveSpeakersSection($data);

    if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
        echo json_encode(['success' => true, 'message' => 'Konuşmacılar bölümü güncellendi!']);
        exit;
    }
}
...
if (!$speakersSection) {
    $speakersSection = [
        'title' => 'Konuşmacılarımız',
        'description' => 'Alanında uzman konuşmacılarımız...'
    ];
}
?>
